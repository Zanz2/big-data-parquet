...
def convert_visdrone_to_parquet(input_image_folder: str, output_parquet_folder: str, batch_size: int):
...
if __name__ == "__main__":
    ...
    for type_map in type_map_list:
        ...
        input_path = f"E:\\public_datasets\\VisDrone\\{type_map}\\images"
        output_path = f"E:\\public_datasets\\VisDrone_parquet\\data\\{type_map}"
        
        convert_visdrone_to_parquet(
